    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('circles', models.CharField(choices=[('3', 'Lv3_미인증사용자'), ('2', 'Lv2_인증사용자'), ('1', 'Lv1_관리자'), ('0', 'Lv0_개발자')], max_length=18, null=True, verbose_name='동아리')),
                ('department', models.CharField(choices=[('3', 'Lv3_미인증사용자'), ('2', 'Lv2_인증사용자'), ('1', 'Lv1_관리자'), ('0', 'Lv0_개발자')], max_length=24, null=True, verbose_name='학과')),
